...
function Navbar(props){
    let itemCount
    itemCount = props.item.itemNumber
    console.log(itemCount)
    const NotificationIcon =
    (<div className='cart pointer' onClick={props.click} style={{ position: 'relative' }}>
      ...
      <div className={props.item.itemNumber ? 'counter--show': 'counter--hide'}>
        {itemCount}
      </div>
    </div>)
